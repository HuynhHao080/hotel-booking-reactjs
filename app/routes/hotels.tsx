    ...
    <div className="min-h-screen bg-gradient-to-b from-[#faf7f2] to-[#f4ede4] text-[#4b2e1e] p-6 md:p-12 font-sans">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-12">
        <input
          ...
          className="flex-1 border border-[#d3b98e] rounded-2xl px-5 py-3 bg-white/80 backdrop-blur-md 
        ...
        <button
          ...
          className="flex items-center justify-center bg-gradient-to-r from-[#caa968] to-[#e4cfa3] 
                     text-[#4b2e1e] font-semibold px-6 py-3 rounded-2xl shadow-md hover:shadow-lg 
      ...
      {/* Hotel List */}
      {hotels.length === 0 ? (
        <p className="text-[#6e4b33]/70 text-lg text-center">
